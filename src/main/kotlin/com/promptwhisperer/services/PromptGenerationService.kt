...
interface PromptGenerationService {
    fun generatePrompt(taskDescription: String, context: SafeProjectContext?): String
}
...
class PromptGenerationServiceImpl : PromptGenerationService {
    override fun generatePrompt(taskDescription: String, context: SafeProjectContext?): String {
